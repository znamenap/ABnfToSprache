...
namespace AbnfToSprache.Tests
{
    ...
    public class GroupTests
    {
        ...
        public void TestWithRepeatCountAndElement()
        {
            // = Setup
            // = Exercise
            var actual = ABNFParser.Group.TryParse("( \t 1\"string a\"/ 1\"string b\"/%x20)");

            // = Outcome
            var actualValueRoot = ParseResult.ValueInstanceOf<GroupExpression>(actual);
        ...
        public void TestWithRepeatRangeAndElement()
        {
            // = Setup
            // = Exercise
            var actual = ABNFParser.Group.TryParse("(1*3<s-t-r-i-n-g> / *<s-t-r-i-n-g>)");
        ...
        public void TestWithRepeatRangeAndElementSeparatedByMoreWsps()
        {
            // = Setup
            // = Exercise
            var actual = ABNFParser.Group.TryParse("(1*3<s-t-r-i-n-g> / ; comment  " + Environment.NewLine + "\t *<s-t-r-i-n-g>)");
        ...
        public void TestWithElementOnly()
        {
            // = Setup
            // = Exercise
            var actual = ABNFParser.Group.TryParse("(\"string\")");
        ...
        public void TestWithThreeElements()
        {
            // = Setup
            // = Exercise
            var actual = ABNFParser.Group.TryParse("(\"string a\" \"string b\" \"string c\")");
